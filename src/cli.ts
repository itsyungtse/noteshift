...
async function main() {
    ...
    const fetchPageContentTask = await task('Fetching Notion page content...', async ({ setTitle }) => {
    ...
    const blocksToHTMLTask = await task('Converting Notion content to HTML...', async ({ setTitle }) => {
