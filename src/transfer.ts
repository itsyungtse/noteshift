import { PartialBlockObjectResponse, BlockObjectResponse } from "@notionhq/client";
import { execFileSync } from "child_process";

/** Convert only paragraphs → HTML (simple, enough for testing) */
function blocksToHTML(blocks: (PartialBlockObjectResponse | BlockObjectResponse)[]): string {
    let html = "";
